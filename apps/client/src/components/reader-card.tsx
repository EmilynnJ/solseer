...
// ⚡ Bolt: Memoize ReaderCard to prevent unnecessary re-renders when filtering reader lists
// and add lazy loading + async decoding to profile images to avoid blocking main thread / network on initial render.
