...
// Memoize ReaderCard to prevent unnecessary re-renders when parent state (e.g., filter selection on ReadersPage) changes.
// Adds loading="lazy" and decoding="async" to defer image loading for off-screen cards and reduce main-thread decoding work.
