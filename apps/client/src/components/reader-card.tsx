...
// ⚡ Bolt: Memoize ReaderCard component to prevent unnecessary re-renders when
// filtering reader lists or when parent state updates.
// Off-screen profile images use loading="lazy" and decoding="async" to defer fetching/decoding.
