...
// ⚡ Bolt: Memoizing ReaderCard to prevent unnecessary re-renders when filtering reader lists,
// and adding loading="lazy" + decoding="async" to defer off-screen profile image loading.
