...
// Performance Optimization: ReaderCard is memoized with React.memo to prevent
// unnecessary re-renders when filtering reader lists on ReadersPage/HomePage.
// Image fetching is deferred using loading="lazy" and decoding="async".
