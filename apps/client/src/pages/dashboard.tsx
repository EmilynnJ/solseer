...
function ClientDashboard() {
  ...
  // ⚡ Bolt: Memoize filtered reading arrays and aggregations to prevent redundant processing on parent re-renders.
...
function ReaderDashboard() {
  ...
  // ⚡ Bolt: Memoize filtered arrays to avoid re-filtering history readings on every keystroke in form fields.
