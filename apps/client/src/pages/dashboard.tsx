...
function ClientDashboard() {
  ...
  // ⚡ Bolt: Memoize reading history filtering and metrics calculation to avoid
  // re-calculating on unrelated state changes (like toggling topUp modal)
  const { active, completed, totalInvested, reviewCount } = useMemo(() => {
...
function ReaderDashboard() {
  ...
  // ⚡ Bolt: Memoize reading history partitioning to prevent redundant array filtering
  // on every keystroke when the Reader edits profile or rate settings
