...
function ClientDashboard() {
  ...
  // ⚡ Bolt: Memoize reading status filters and aggregations to prevent
  // redundant array filtering and reducing when local state (e.g. topUp modal) changes
...
function ReaderDashboard() {
  ...
  // ⚡ Bolt: Memoize pending and completed reading filters to avoid re-calculating
  // array filters on every heartbeat interval or rate/profile form input change
