...
function ClientDashboard() {
  ...
  // ⚡ Bolt: Memoize filtered reading arrays and aggregated financial/review metrics
  // to avoid redundant array filtering and metric reductions on every state change / re-render.
...
function ReaderDashboard() {
  ...
  // ⚡ Bolt: Memoize pending and completed history arrays so typing into bio,
  // rate, or notification inputs does not trigger array filtering on every keypress.
